    ...
    if (field == 'users') {
        ...
        for (const [key, value] of Object.entries(users)) {
            ...
            if (val.match(text) != null && limit < 50) {
                ...
                var base = '      <div class="clearfix colelem box scale-up-center user" onclick="chooseToAdd(\'' + key + '\')" id="' + key.replace(":", "-") + '""><!-- group -->' +
    ...
    if (field == 'profiles') {
        ...
        for (const [key, value] of Object.entries(users)) {
            ...
            if (val.match(text) != null && limit < 50) {
                ...
                var base = '      <div class="clearfix colelem box scale-up-center user" onclick="openProfile(\'' + key + '\')" id="' + key.replace(":", "-") + '""><!-- group -->' +
                    '       <div class="grpelem" id="u1258" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>' +
                    '       <div class="grpelem" id="u1259" style="background: url(' + url + '); background-size: cover;" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>' +
                    '       <div class="clearfix grpelem" id="u1260-4" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- content -->' +
                    '        <p>' + value.firstname + ' ' + value.lastname + '</p>' +
...
function openStaffProfile(k, departament) {
    ...
    for (const [key, value] of Object.entries(badges)) {
        ...
        if (current.badges[key]) {
            ...
            var badge = '      <div class="grpelem slide-top2" id="u2279" style="background: rgba(66, 66, 66, 1.0) url(img/badges/' + key + '.png); background-size: cover;"  data-sizePolicy="fixed" data-pintopage="page_fluidx"><div id="badgeInfo" class="scale-up-center">' + value + '</div></div>';
...
function chooseToAdd(k) {
    ...
    if (addingField == "evidence") {
        ...
        var evid = '       <div class="clearfix colelem slide-right crims" id="evidence-' + k + '"><!-- group -->' +
            ...
            '        <div class="grpelem" id="u932" onclick="openEvidence(\'' + k + '\')" data-sizePolicy="fixed" data-pintopage="page_fluidx"><i class="fas fa-eye" style="margin-top: 10px;"></i></div>' +
...
function addEvidence() {
    ...
    base = base + '    </div>' +
        ...
        '    <div class="grpelem box" id="u1957" onclick="saveCharges()" data-sizePolicy="fixed" data-pintopage="page_fluidx"><i class="far fa-save"></i></div></div>';
...
function selectBadge(badge) {
    ...
    var badgee = '      <div class="grpelem slide-top" onclick="removeBadge(\'' + badge + '\')" id="u2279" style="background: rgba(66, 66, 66, 1.0) url(img/badges/' + badge + '.png); background-size: cover;"  data-sizePolicy="fixed" data-pintopage="page_fluidx"><div id="badgeInfo" class="scale-up-center">' + badges[badge] + '</div></div>';
...
function addBadge() {
    ...
    base = base + '    </div>' +
        ...
        '    <div class="grpelem box" id="u1957" onclick="closeAdding(\'addingbadge\')" data-sizePolicy="fixed" data-pintopage="page_fluidx"><i class="far fa-times"></i></div></div>';
...
function addToIncident(field) {
    ...
    base = base + '    </div>' +
        ...
        '    <div class="grpelem box" id="u1957"  onclick="closeAdding(\'addingusers\')" data-sizePolicy="fixed" data-pintopage="page_fluidx"><i class="far fa-times"></i></div></div>';
...
if (checkPerms('editincident')) {
    ...
    base = base + '    </div>' +
       ...
       base = base + '    <div class="clearfix grpelem" id="u1229-4" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- content -->' +
        ...
        '     0 MONTHS' +
        '    </div>' +
        '    <div class="grpelem box" id="u1958" onclick="saveCharges()" data-sizePolicy="fixed" data-pintopage="page_fluidx"><i class="far fa-save"></i></div></div>';
    ...
    for (const [key, value] of Object.entries(incidents)) {
        ...
        for (const [key2, value2] of Object.entries(value.crims)) {
            ...
            if (diffHours > 0) {
                ...
                activeWarrants[key2].name = users[key2].name;
            }



            if (diffHours < warrantending) {



                var url = users[key2].mdw_image;
                if (url == null || url == '') {
                    url = "img/placeholder.png"
                }

                base = base + '      <div class="clearfix colelem box" onclick="openProfile(\'' + key2 + '\')" id="pu707"><!-- group -->' +
                    '       <div class="grpelem" id="u707" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>' +
                    '       <div class="grpelem" style="background: url(' + url + '); background-size: cover;" id="u708" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>' +
                    '       <div class="clearfix grpelem" id="u709-4" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- content -->' +
                    '        <p>' + users[key2].name + '</p>' +
                    '       </div>' +
                    '       <div class="clearfix grpelem" id="u1895-4" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- content -->' +
                    '        <p>WARRANT EXPIRES IN ' + diffHours + ' HOURS</p>' +
                    '       </div>' +
                    '      </div>';
...
function openMDW() {
    ...
    var base = '<div class="clearfix borderbox slide-top" id="page"><!-- group -->' +
        '   <div class="grpelem" id="u462" data-sizePolicy="fluidWidth" data-pintopage="page_fixedCenter"><!-- simple frame --></div>' +
        ...
        '   <div class="shadow grpelem" id="u472" data-sizePolicy="fluidWidth" data-pintopage="page_fixedCenter"><!-- simple frame --></div>' +
        ...
        '   </div>' +
        '   <div class="verticalspacer" data-offset-top="0" data-content-above-spacer="1000" data-content-below-spacer="1078" data-sizePolicy="fixed" data-pintopage="page_fixedLeft"></div>' +
        '  </div>';
